      ...
      <head>
        ...
        <Script id="ms-clarity" strategy="afterInteractive">
          {`
            ...
            })(window, document, "clarity", "script", "vmunrv69k1");
          `}
        </Script>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2164866171012385&ev=PageView&noscript=1"
          />
        </noscript>
      </head>
      <body className="antialiased">
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-J3173WG7FN"
